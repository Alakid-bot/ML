...
_LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "residual_enabled": "MLP supplement enabled",
        "adaptive_diagnostics_header": "Adaptive hybrid model checks",
        "diagnostic_name": "Diagnostic",
        "diagnostic_value": "Value",
        "residual_gate_reason": "Enablement result",
        "backbone_rmse": "Ridge-only RMSE",
        "hybrid_rmse": "Combined model validation RMSE",
        "residual_improvement": "RMSE reduction versus Ridge",
        "min_improvement": "Minimum required RMSE reduction",
        "training_rows": "Training rows for the check",
        "validation_rows": "Validation rows for the check",
    },
    "zh": {
        "app_title": "网络服务负载预测",
        ...
        "model_strategy": "模型策略",
        "residual_enabled": "启用 MLP 补充",
        "adaptive_diagnostics_header": "自适应混合模型检查",
        "diagnostic_name": "诊断项",
        "diagnostic_value": "值",
        "residual_gate_reason": "启用判断结果",
        "backbone_rmse": "仅使用 Ridge 的 RMSE",
        "hybrid_rmse": "组合模型验证 RMSE",
        "residual_improvement": "相对 Ridge 的 RMSE 降低比例",
        "min_improvement": "最低要求 RMSE 降低比例",
        "training_rows": "用于判断的训练行数",
        "validation_rows": "用于判断的验证行数",
    },
}
